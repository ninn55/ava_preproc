...
#----------------------------------------------------#
#Move keyframes to specified folder
#----------------------------------------------------#
...
#----------------------------------------------------#
#Move clips to specified folder
#----------------------------------------------------#
#video_id: Video id, file name with no extension
#time_id: Count from start of the video in second
#----------------------------------------------------#
...
#----------------------------------------------------#
#Check for unvalidated frames
#----------------------------------------------------#
#annot_csv: set generated by comutil.readcsv
#----------------------------------------------------#
#dic: set containing (video_id, time_id) of unvalidated frames
#----------------------------------------------------#
...
#----------------------------------------------------#
#Delete tagged but unvalid frames from annotated csv file.
#----------------------------------------------------#
#dic: set generated by unvalidframes.
#----------------------------------------------------#
